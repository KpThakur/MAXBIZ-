...
const join = (props) => {
  const { select, toValidtIdentity, toCertifyBisnuess } = props;
  return (
      ...
      <ScrollView>
        <View style={style.firstContainer}>
          <Text style={style.firstText}>
            {StringsOfLanguages.JOIN_SmbMarket}
          </Text>
          <Text style={[style.firstText, { bottom: scale(12) }]}>
            {StringsOfLanguages.GET_FREE_LOCAL}
          </Text>
          <Text style={[style.firstText, { bottom: scale(20) }]}>
            {StringsOfLanguages.LEADS}
          </Text>
        </View>
        <View style={style.inContainer}>
          ...
          >
            {select === 1 ? (
                ...
                <View style={style.selectItem}>
                  ...
                  <View style={style.selectedTxt}>
                    <Text style={style.selectText}>
                      {StringsOfLanguages.VALIDATE_YOUR}
                    </Text>
                    <Text style={[style.selectText, style.bottom]}>
                      {StringsOfLanguages.IDENTITY}
                    </Text>
                  </View>
                </View>
              </View>
              ...
              <View style={[style.nonSelect, commomstyle.shadowContainer]}>
                <Image resizeMode="cover" source={ICONS.validateIcon} />
                <View style={style.nonSelectdTxt}>
                  <Text style={style.nonSelectText}>
                    {StringsOfLanguages.VALIDATE_YOUR}
                  </Text>
                  <Text style={[style.nonSelectText, style.bottom]}>
                    {StringsOfLanguages.IDENTITY}
                  </Text>
                </View>
              </View>
          ...
          >
            {select === 2 ? (
              ...
              <View style={[style.nonSelect, commomstyle.shadowContainer]}>
                <Image resizeMode="cover" source={ICONS.registerIcon} />
                <View style={style.nonSelectdTxt}>
          ...
          >
            {select === 3 ? (
              <View style={style.selectStyle}>
                ...
                <View style={style.selectItem}>
                  <Image
                    style={{ tintColor: WHITE_COLOR, marginRight: scale(4) }}
                    source={ICONS.certifyIcon}
                  />
                  <View
                    style={[style.selectedTxt, { paddingRight: scale(32) }]}
                  >
              ...
              <View style={[style.nonSelect, commomstyle.shadowContainer]}>
                ...
                />
                <View
                  style={[style.nonSelectdTxt, { paddingRight: scale(32) }]}
                >
