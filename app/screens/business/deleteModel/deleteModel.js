      ...
      <View
        ...
        <View style={[style.modalContainer]}>
          <View style={style.topheading}>
            <Text style={style.topheadingtext}>{StringsOfLanguages.DELETE}{filetype === 'video' ? 'Video' : filetype ==='photo' ? 'Photo' : filetype ==='document' ? 'Document' : 'File'}</Text>
          ...
          <View style={style.midelcontent}>
            <Text style={style.confirmtxt}>{StringsOfLanguages.ARE_YOU_SURE_YOU_WANT_TO_DELETE}{filetype === 'video' ? 'Video' : filetype ==='photo' ? 'Photo' : filetype ==='document' ? 'Document' : 'File'} ?</Text>
         </View>
          <View style={style.bottumbutton}>

          <View style={style.buttonview}>
            <Button  onPress={() => deletecontent() }
              buttonText={StringsOfLanguages.YES}
            />
         </View>
         <View style={style.buttonview}>
            <Button onPress={ () => setDeleteModel(!deleteModel) }
