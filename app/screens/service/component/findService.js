...
const FindService = (props) => {
    const { showSearch, getAllservices, toggleShowSearch, navigation, searchdata, setSearchdata, serviceList, allServices, searchServicebyname, getcitylist, allCity } = props
    const showDetail = (serviceDetail) => {
        navigation.navigate("serviceDetailScreen", { serviceDetaildata: serviceDetail, searchdata: searchdata });
    }
    return (
                        ...
                        <View style={styles.inputWrapper}>
                            <View style={styles.inputView}>
                                ...
                                <View style={styles.inputButton}>
                                    <TouchableOpacity >
                                        <Button onPress={() => getAllservices(searchdata.serviceid,searchdata.cityid)}
